...
const projects = [
    {
        ...
        title: "EASY JOB",
        description:
            "Easy Job is an AI-powered app that helps job seekers of all backgrounds find employment including unskilled, freshers and experienced candidates at one platform.",
    ...
    },
    {
        ...
        title: "ABACUS CLOUD",
        description:
            "Abacus Cloud a storage platform where users can store their data files and many more things with premium features...",
    ...
    },
    {
        ...
        description:
            "Perfect Propertys is a real estate platform designed to connect builders, brokers, and clients looking for properties, PG (Paying Guest accommodations), and rentals...",
    ...
    },
    {
        ...
        description:
            "SkywayHoliday app revolutionizes the hotel booking experience for travelers visiting Pattaya. With just a few taps, users can easily book their stay...",
                        ...
                        >
                            ...
                            >
                                <img
                                    src={project.image}
                                    alt={project.title}
                                    style={{ borderRadius: "8px", width: "10rem", height: "auto", maxHeight: "150px" }}
                                />
                                <Typography
                                    variant="h6"
                                    component="h3"
