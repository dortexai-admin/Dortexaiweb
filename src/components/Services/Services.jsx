  ...
  return (
    <>
        ...
        <div className="flex justify-between w-full px-2">
            <h1 className=" text-5xl text-customDark font-bold">Our Services</h1>
            <a className="hire_usinline-block bg-blue-900 text-white no-underline py-4 px-12 rounded-md text-base transition-colors duration-300 ease-in-out font-semibold hover:bg-purple-700 " href="#hire"> Hire Us</a>
        </div>
